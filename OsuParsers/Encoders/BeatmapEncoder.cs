...
{
    public static string EncodeString(Beatmap beatmap)
    {
        var lines = Encode(beatmap);
        return string.Join("\n", lines);
    }
    ...
    public static List<string> EditorSection(BeatmapEditorSection section)
    {
        ...
        if (section.Bookmarks is not null)
    ...
    public static List<string> TimingPoints(List<TimingPoint> timingPoints)
    {
        ...
        if (timingPoints is not null)
            list.AddRange(timingPoints.Select(WriteHelper.TimingPoint));
    ...
    public static List<string> Colours(BeatmapColoursSection section)
    {
        ...
        if (section.ComboColours is not null)
    ...
    public static List<string> HitObjects(List<HitObject> hitObjects)
    {
        ...
        if (hitObjects is not null)
            list.AddRange(hitObjects.Select(WriteHelper.HitObject));
        return list;
    }
