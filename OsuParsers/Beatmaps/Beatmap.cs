...
public class Beatmap
{
    ...
    {
        // This is suboptimal, but does the job without requiring
        // intensive maintenance of the optimal cloning method
        var lines = BeatmapEncoder.Encode(this);
        return BeatmapDecoder.Decode(lines);
    }
